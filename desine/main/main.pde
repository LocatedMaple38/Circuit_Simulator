...
float[] xANDVSS = new float[a74hc08], yANDVSS = new float[a74hc08], widhtANDVSS = new float[a74hc08], heightANDVSS = new float[a74hc08];
float[] xANDVDD = new float[a74hc08], yANDVDD = new float[a74hc08], widthANDVDD = new float[a74hc08], heightANDVDD = new float[a74hc08];
float[] xANDA1 = new float[a74hc08], yANDA1 = new float[a74hc08], widthANDA1 = new float[a74hc08], heightANDA1 = new float[a74hc08];
