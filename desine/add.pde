void addSetup(){
    ...
    xItemAdd3-3VSupply = 50;
    yItemAdd3-3VSupply = 90;
    widhtItemAdd3-3VSupply = 50; 
    heightItemAdd3-3VSupply = 10;
}
...
void addAsetDraw(){
    ...
    rect(xItemAdd3-3VSupply, yItemAdd3-3VSupply, widhtItemAdd3-3VSupply, heightItemAdd3-3VSupply);
    fill(0);
    ...
    text("3.3V Supply", xItemAdd3-3VSupply, yItemAdd3-3VSupply, widhtItemAdd3-3VSupply, heightItemAdd3-3VSupply)
    noFill();
}
/*
